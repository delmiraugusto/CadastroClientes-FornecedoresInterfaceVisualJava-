...
public class JanelaCadastroFornecedor extends javax.swing.JDialog {
    ...
    public static boolean executar(java.awt.Frame parent,
      ...
      JanelaCadastroFornecedor frmPessoa = new JanelaCadastroFornecedor(parent,operacaoCadastro, fornecedor);
      frmPessoa.setLocationRelativeTo(null);
      frmPessoa.setVisible(true);
      return frmPessoa.operacaoConfirmada();
    }
    
    public JanelaCadastroFornecedor(java.awt.Frame parent,
                     OperacaoCadastro operacaoCadastro,
                     Fornecedor fornecedor){
        super (parent, true);
        confirmado = false;
        ...
        if (operacaoCadastro == OperacaoCadastro.ocAlterar ||
            ...
            edCNPJ.setText(fornecedor.getCnpj());
            edLogradouro.setText(fornecedor.getLogradouro());
            edNumero.setText(fornecedor.getNumero());
            edComplemento.setText(fornecedor.getComplemento());
            edBairro.setText(fornecedor.getBairro());
            edCidade.setText(fornecedor.getCidade());
            edEstado.setSelectedItem(fornecedor.getEstado());
            edCep.setText(fornecedor.getCep());
        }
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(edCNPJ, javax.swing.GroupLayout.PREFERRED_SIZE, 164, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void buOk4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buOk4ActionPerformed
        if (operacaoCadastro != OperacaoCadastro.ocConsultar){
            ...
            fornecedor.setCnpj(edCNPJ.getText());
            fornecedor.setEmail(edEmail.getText());
            fornecedor.setCep(edCep.getText());
            fornecedor.setEstado(edEstado.getSelectedItem().toString());
            fornecedor.setLogradouro(edLogradouro.getText());
            fornecedor.setNumero(edNumero.getText());
            fornecedor.setComplemento(edComplemento.getText());
            fornecedor.setBairro(edBairro.getText());
            fornecedor.setCidade(edCidade.getText());
            confirmado = true;
        }
        dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JanelaCadastroFornecedor dialog = new JanelaCadastroFornecedor(new javax.swing.JFrame(), true);
